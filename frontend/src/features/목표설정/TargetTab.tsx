        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <Card className="flex flex-col justify-between items-center text-center">
                    ...
                    <div className={cn(
                        "mt-4 flex items-center justify-center gap-1.5 text-xs font-bold w-fit px-2 py-1 rounded-full",
                ...
                {/* SBTi 목표달성도 */}
                <Card className={cn(
                    "relative flex flex-col justify-between items-center text-center border-2 overflow-visible",
                    ...
                    <div className={cn("mt-4 text-xs font-bold flex items-center justify-center gap-1", sbtiAnalysis.isAhead ? "text-[#10b77f]" : "text-red-500")}>
                ...
                {/* Net Zero 2050 */}
                <Card className="flex flex-col justify-between items-center text-center bg-[#10221c] text-white border-[#1a2e28]">
                ...
                <Card padding="lg" className="lg:col-span-10 flex flex-col min-w-0 bg-transparent border-none shadow-none">
                    ...
                    <div className="h-[450px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <ComposedChart data={sbtiAnalysis.trajectory} margin={{ top: 10, right: 40, left: 10, bottom: 0 }}>
