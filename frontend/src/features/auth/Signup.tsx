...
export const Signup: React.FC<SignupProps> = ({ onBack, onComplete }) => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (name === 'email') {
            setEmailWarning(hangulRegex.test(value) ? '영문/숫자로 입력해주세요.' : '');
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full px-4 py-3 rounded-xl border ${errors.email ? 'border-red-300 bg-red-50' : 'border-gray-200'} focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-4 py-3 pr-12 rounded-xl border ${errors.confirmPassword ? 'border-red-300 bg-red-50' : 'border-gray-200'} focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all`}
