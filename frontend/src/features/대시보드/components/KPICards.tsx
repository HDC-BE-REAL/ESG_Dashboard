...
import { Cloud, Euro, Activity, CheckCircle2, TrendingDown, TrendingUp, AlertCircle } from 'lucide-react';
    ...
    return (
        <div className={dashboardStyles.kpiGrid}>
            ...
            >
                ...
                <p className={dashboardStyles.kpiCard.label}>EU 리스크 노출액</p>
                <p className={dashboardStyles.kpiCard.value}>€ {riskExposure}M</p>
            ...
            >
                ...
                <div className={dashboardStyles.kpiCard.header}>
                    <div className={`${dashboardStyles.kpiCard.icon.container} ${dashboardStyles.kpiCard.icon.slate}`}>
